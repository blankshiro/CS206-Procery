          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                ...
                Text('Howdy, let\'s authenticate 3334', style: taglineText),
            ...
            Positioned(
              ...
              child: FlatButton(
                onPressed: () {
                    Navigator.pushReplacement(context, PageTransition(type: PageTransitionType.rightToLeft, child: DashboardExplore()));
                },
                color: primaryColor,
